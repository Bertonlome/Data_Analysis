...
Usage
-----
  python performance/navigate_perf.py           # interactive participant selection
  python performance/navigate_perf.py P02       # run directly for participant P02
  python performance/navigate_perf.py 3         # run for 3rd participant in the list
"""
