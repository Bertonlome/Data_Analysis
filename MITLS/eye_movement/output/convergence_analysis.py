...
from MITLS.eye_movement.output.compare import find_csv_files, aggregate_run_data, calculate_jae_data_baseline, aggregate_jae_data
...
def progressive_analysis(run_files, run_number, target_precision=0.05, confidence=0.95, max_n=None):
    ...
    from MITLS.eye_movement.output.compare import extract_run_data, load_task_summary_csv
        ...
        if all_repetition_tasks:
            ...
            if ed_baseline:
                ...
                for rep_tasks in all_repetition_tasks:
                    from MITLS.eye_movement.output.compare import calculate_jae_metrics
